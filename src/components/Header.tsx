...
const doctors = [
  { name: "Dr. Sanjay Garg", href: "/doctor/dr-sanjay-garg" },
  { name: "Dr. Ritu Garg", href: "/doctor/dr-ritu-garg" },
  { name: "Dr. Priyansh Garg", href: "/doctor/priyansh-garg" },
  { name: "Dr. Pranjal Garg", href: "/doctor/pranjal-garg" },
];

const educationInstitutes = [
  {
    name: "Santushti Institute Of Nursing & Paramedical Sciences",
    href: "#education",
  },
  { name: "Santushti College Of Nursing", href: "#education" },
  { name: "Santushti College Of Higher Studies", href: "#education" },
  {
    name: "Santushti Ayurvedic Nursing College & Hospital",
    href: "#education",
  },
];
                      ...
                      {doctors.map((doctor) => (
                        <li key={doctor.name}>
                          <NavigationMenuLink asChild>
                            <Link
                              to={doctor.href} // Changed 'href' to 'to'
